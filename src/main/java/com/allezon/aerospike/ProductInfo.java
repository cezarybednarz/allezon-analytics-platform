...
public class ProductInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -887630711217929106L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductInfo\",\"namespace\":\"com.allezon.aerospike\",\"fields\":[{\"name\":\"product_id\",\"type\":\"string\"},{\"name\":\"brand_id\",\"type\":\"string\"},{\"name\":\"category_id\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"int\"}]}");
   ...
   */
  public static com.allezon.aerospike.ProductInfo.Builder newBuilder() {
    return new com.allezon.aerospike.ProductInfo.Builder();
  }
   ...
   * @return A new ProductInfo RecordBuilder
   */
  public static com.allezon.aerospike.ProductInfo.Builder newBuilder(com.allezon.aerospike.ProductInfo.Builder other) {
    if (other == null) {
      return new com.allezon.aerospike.ProductInfo.Builder();
    } else {
      return new com.allezon.aerospike.ProductInfo.Builder(other);
    }
  }
   ...
   * @return A new ProductInfo RecordBuilder
   */
  public static com.allezon.aerospike.ProductInfo.Builder newBuilder(com.allezon.aerospike.ProductInfo other) {
    if (other == null) {
      return new com.allezon.aerospike.ProductInfo.Builder();
    } else {
      return new com.allezon.aerospike.ProductInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductInfo>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.allezon.aerospike.ProductInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.allezon.aerospike.ProductInfo other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder clearProductId() {
      product_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder setBrandId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder clearBrandId() {
      brand_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder setCategoryId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder clearCategoryId() {
      category_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder setPrice(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.ProductInfo.Builder clearPrice() {
