...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5251429263840237767L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.allezon.aerospike\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"field1\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public Message(java.lang.Long id, java.lang.CharSequence field1) {
    this.id = id;
    this.field1 = field1;
  }
   ...
   */
  public static com.allezon.aerospike.Message.Builder newBuilder() {
    return new com.allezon.aerospike.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.allezon.aerospike.Message.Builder newBuilder(com.allezon.aerospike.Message.Builder other) {
    if (other == null) {
      return new com.allezon.aerospike.Message.Builder();
    } else {
      return new com.allezon.aerospike.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.allezon.aerospike.Message.Builder newBuilder(com.allezon.aerospike.Message other) {
    if (other == null) {
      return new com.allezon.aerospike.Message.Builder();
    } else {
      return new com.allezon.aerospike.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.allezon.aerospike.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.allezon.aerospike.Message other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.Message.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.Message.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.Message.Builder setField1(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.Message.Builder clearField1() {
      field1 = null;
