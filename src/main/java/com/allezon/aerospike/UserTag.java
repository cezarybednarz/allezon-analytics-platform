...
public class UserTag extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.allezon.aerospike.ProductInfo product_info;
   ...
   */
  public UserTag(java.lang.CharSequence time, java.lang.CharSequence cookie, java.lang.CharSequence country, java.lang.CharSequence device, java.lang.CharSequence action, java.lang.CharSequence origin, com.allezon.aerospike.ProductInfo product_info) {
    this.time = time;
    this.cookie = cookie;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: product_info = (com.allezon.aerospike.ProductInfo)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.allezon.aerospike.ProductInfo getProductInfo() {
    return product_info;
  }
   ...
   * @param value the value to set.
   */
  public void setProductInfo(com.allezon.aerospike.ProductInfo value) {
   ...
   */
  public static com.allezon.aerospike.UserTag.Builder newBuilder() {
    return new com.allezon.aerospike.UserTag.Builder();
  }
   ...
   * @return A new UserTag RecordBuilder
   */
  public static com.allezon.aerospike.UserTag.Builder newBuilder(com.allezon.aerospike.UserTag.Builder other) {
    if (other == null) {
      return new com.allezon.aerospike.UserTag.Builder();
    } else {
      return new com.allezon.aerospike.UserTag.Builder(other);
    }
  }
   ...
   * @return A new UserTag RecordBuilder
   */
  public static com.allezon.aerospike.UserTag.Builder newBuilder(com.allezon.aerospike.UserTag other) {
    if (other == null) {
      return new com.allezon.aerospike.UserTag.Builder();
    } else {
      return new com.allezon.aerospike.UserTag.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserTag>
    ...
    private com.allezon.aerospike.ProductInfo product_info;
    private com.allezon.aerospike.ProductInfo.Builder product_infoBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.allezon.aerospike.UserTag.Builder other) {
      super(other);
      ...
      if (other.hasProductInfoBuilder()) {
        this.product_infoBuilder = com.allezon.aerospike.ProductInfo.newBuilder(other.getProductInfoBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.allezon.aerospike.UserTag other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setTime(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearTime() {
      time = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setCookie(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearCookie() {
      cookie = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setCountry(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearCountry() {
      country = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setDevice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearDevice() {
      device = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setAction(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearAction() {
      action = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setOrigin(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearOrigin() {
      origin = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder setProductInfo(com.allezon.aerospike.ProductInfo value) {
     ...
     * @return This builder.
     */
    public com.allezon.aerospike.ProductInfo.Builder getProductInfoBuilder() {
      if (product_infoBuilder == null) {
        if (hasProductInfo()) {
          setProductInfoBuilder(com.allezon.aerospike.ProductInfo.newBuilder(product_info));
        } else {
          setProductInfoBuilder(com.allezon.aerospike.ProductInfo.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.allezon.aerospike.UserTag.Builder setProductInfoBuilder(com.allezon.aerospike.ProductInfo.Builder value) {
      clearProductInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.allezon.aerospike.UserTag.Builder clearProductInfo() {
      product_info = null;
    ...
    public UserTag build() {
      try {
        ...
        if (product_infoBuilder != null) {
          ...
          record.product_info = fieldSetFlags()[6] ? this.product_info : (com.allezon.aerospike.ProductInfo) defaultValue(fields()[6]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.product_info == null) {
        this.product_info = new com.allezon.aerospike.ProductInfo();
      }
